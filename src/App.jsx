...
import { BiBrain } from 'react-icons/bi' // Use BiBrain instead of BsBrainHalf
      ...
      <section id="infographics" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Example infographic cards with images */}
            {[
              {
                title: "Market Trends",
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-200">
                ...
                <li>123 Analytics Street<br />Data City, DC 12345</li>
              </ul>
            </div>
            <div>
